  ...
  return (
    <div className='overall-hero-section'>
        <div className="left-hero container">
          <h2>Dive into Delights of Delectable <span>Food</span></h2>
          <p>Where each plate Waves a story of Culinary Mastery and passionate Craftmanship</p>

          <div className="bottom-section-hero">
            <div className="div-button-hero text-light">Order now</div>
            <div className="watch-video-container">
              Watch video <span className='play-icon-container rounded-circle' ><FaPlay /></span>
            </div>
          </div>
